...
- In a terminal, navigate to `FIAP.MachineLearning.QnAMaker`

    ```bash
    # change into project folder
    cd FIAP.MachineLearning.QnAMaker
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `FIAP.MachineLearning.QnAMaker` folder
  - Select `FIAP.MachineLearning.QnAMaker.csproj` file
